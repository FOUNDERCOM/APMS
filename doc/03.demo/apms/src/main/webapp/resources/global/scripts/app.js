...
var App = function() {
    ...
    var handleTabs = function() {
        ...
        if (encodeURI(location.hash)) {
            ...
            tab.parents('.tab-pane:hidden').each(function() {
    ...
    var handleModals = function() {
        ...
        body.on('hide.bs.modal', function() {
            var html = $('html');
            var modal_visible = $('.modal:visible');
            if (modal_visible.size() > 1 && html.hasClass('modal-open') === false) {
                html.addClass('modal-open');
            } else if (modal_visible.size() <= 1) {
    ...
    var handleFancybox = function() {
        ...
        var fancybox_btn = $(".fancybox-button");
        if (fancybox_btn.size() > 0) {
    ...
    return {
        ...
        alert: function(options) {
            ...
            if (!options.container) {
                var page_fixed_main_content = $('.page-fixed-main-content');
                if (page_fixed_main_content.size() === 1) {
                    page_fixed_main_content.prepend(html);
