 ...
 * @author Jimmybly Lee
 */
angular.module('WebApp').controller('StationListCtrl', ['$scope', "$listService", "$ajaxCall", function ($scope, $listService, $ajaxCall) {
    ...
    $scope.prepareToAdd = function () {
        var scope = $("#StationModifyCtrl").scope();
        scope.title = "添加处室信息";
        scope.method = "create";
        scope.entity = {};
    ...
    /** make demo data */
    $scope.demo = function() {
        $.getJSON("packages/dept/js/station/demo.json", function(obj) {
